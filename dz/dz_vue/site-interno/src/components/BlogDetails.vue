<template>
  <div class="container_blog_details">
    <div class="blog_details_left kitchen" v-for="(item, index) in kitchenDetailsBlog"
      :key="index" v-show="selectedCategory === 'Кухня'">
    ...
    <div class="blog_details_left badroom" v-for="(item, index) in bedroomDetailsBlog"
      :key="index" v-show="selectedCategory === 'Спальня'">
      <h2 class="title_blog_one">{{ item.title_one }}</h2>
